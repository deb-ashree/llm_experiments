...
if 'template' not in st.session_state:
   st.session_state.template = """You are a knowledgeable chatbot, here to help with questions of the user on topics related to the PDF content only, else mention nicely that you are not able to provide any details on topics outside the document specific topics. 
